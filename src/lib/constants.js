...
@media(max-width:640px){.grid-4{grid-template-columns:repeat(2,1fr)!important}.grid-3{grid-template-columns:1fr!important}.grid-2{grid-template-columns:1fr!important}.hide-mobile{display:none!important}.show-mobile{display:flex!important}.hero-title{font-size:26px!important;letter-spacing:-.02em!important}.hero-card{padding:28px 20px 24px!important;border-radius:20px!important}.nav-links{display:none!important}.nav-search-wrap{max-width:180px!important;min-width:100px!important}.stat-grid{grid-template-columns:repeat(2,1fr)!important}nav{padding:0 12px!important}section{padding-left:14px!important;padding-right:14px!important}
